package com.hx.hxcrm2.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.hx.hxcrm2.shiro.EmpRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager){
        ...
        filterMap.put("/employee", "perms[employee:list]");
        filterMap.put("/customer", "perms[customer:list]");
        filterMap.put("/business", "perms[business:list]");
